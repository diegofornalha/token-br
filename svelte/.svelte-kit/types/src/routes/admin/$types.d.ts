...
type LayoutRouteId = RouteId | "/admin" | "/admin/actions" | "/admin/activity" | "/admin/burn" | "/admin/info" | "/admin/mint" | "/admin/multisig" | "/admin/overflow" | "/admin/rounds" | "/admin/withdraw"
